...
/- 
For the sake of organization and clarity, we follow these naming conventions:
  - uppercase Greek (Γ, Δ, Φ, ...) for typing contexts
  - lowercase Greek (σ, τ, γ, ...) for types
  - uppercase Latin (X, Y, Z, ...) for type variables
  - lowercase Latin (x, y, z) for term variables
  - lowercase Latin (t₁, t₂, ...) for terms
-/
